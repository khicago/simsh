...
func specDate() engine.CommandSpec {
	return engine.CommandSpec{
		...
		Examples:       ExamplesFor("date"),
		DetailedManual: LoadEmbeddedManual("date"),
		Capabilities:   []string{"compat:date"},
		Run:            runDate,
	}
}

func runDate(runtime engine.CommandRuntime, args []string) (string, int) {
	_ = runtime
	useUTC := false
	formatSpec := ""
