...
For the mount-performance and capability-dispatch side of this problem, especially when adapters expose RPC-to-file views over slower backends, see `docs/architecture-high-performance-mount-system.md`.
