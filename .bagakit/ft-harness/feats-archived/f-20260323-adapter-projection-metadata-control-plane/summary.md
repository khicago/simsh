# Feat Summary: f-20260323-adapter-projection-metadata-control-plane

- Title: Adapter projection metadata and control plane
- Goal: Add explicit source/freshness metadata and a minimal control-plane API to the reference adapter without widening core contracts.
...
- Branch: 
- Worktree: 
- Closed At (UTC): 2026-03-23T14:18:02Z
- Discard Reason: 
- Replacement Feat: 
